...
from .render import CTA, DISCLOSURE, _decorate, _latest_for_category, _spark, _won, build_context, decorate_day
...
def daily_post(date: str | None = None) -> tuple[str, str, str, str, dict[str, Any]]:
    ...
    html = _env.get_template("wp_post.html").render(post=d, disclosure=DISCLOSURE, cta=CTA)
